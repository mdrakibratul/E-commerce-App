  ...
  const logout = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        localStorage.removeItem("token"); // <-- FIX: Remove token from localStorage
          ...
          : (
            <div className=" relative group ">
              ...
              <ul className=" hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40">
                <li className=" p-1.5 pl-3 hover: bg-primary/10 cursor-pointer" onClick={() => navigate('my-order')}>My Order</li>
